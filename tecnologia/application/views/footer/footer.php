<!--    FOOTER    -->    
<footer class="p_footer" style="margin-top: 185px;">   
...
<?php }else{ ?>
	<div class="p_emergenteusuario">        
		...
		<div class="p_emerbox">            
			...
			<!--Pago Stripe-->            
			<form class="p_emerboxconte" id ="formCompra" action="https://www.krismar.com.mx/pagoKSR/informaticaC.php" method="POST" onsubmit="return validarForm();"> <!--Ventana 5-->
