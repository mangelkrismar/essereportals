...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MD5DFPK"
		...
		<div class="p_menusup">	          
			<div class="p_menuconte">	       
				<div class="p_menucontecenter">	      
					...
					<a ng-click="checkForNet('http://www.krismar.com.mx','url')">	
                    ...
                    <div class="p_menuicon libros" id ="libros_sepi" name = "libros_sepi" ng-click="checkForNet('muestraLibrosSecundaria','fun')" >
                        <div class="p_menuimg p_iconlibrosepn">
							<div class = "p_iconlibrosepi"></div>
						</div>
                        <table class="p_menutxt"><tr><td>LIBROS</td></tr></table>
                    </div>
