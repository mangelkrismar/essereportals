	...
	<div ng-show="aplicaciones">
		...
		<article class="p_article" id="buscar">
			<div class="p_articlecenter">
				...
				<!-- Filtro Móvil o PC -->
				<?php if(!$this->bandera_movil){ ?>
					<div class="p_switch" ng-show="false" style="display: block;" ng-show="verApps" ng-click="toggleNoFlash()">
											...
											<div class="p_recienteboximg p_resalteminiatura_over">
												<div class="p_recienteboxminiatura " >
													...
													<div class="p_recienteinfo">
														<div class="p_recienteinfoplay" ng-mouseleave="showHideElement('classroomShareBtn1<?=$app->id_aplicacion?>-cr', 'h')" ng-mouseenter="showHideElement('classroomShareBtn1<?=$app->id_aplicacion?>-cr', 's', '<?=$app->id_aplicacion?>', '<?=$app->prefijo?>', '<?=$app->nombre?>')">
															<!-----GOOGLE CLASSROOM---->
														...
														<!--<div class="p_recienteinfoplay">
															...
															<div class="p_recienteinfoplayicon " onclick = "playDemo(<?=$app->id_aplicacion?>, '<?=$app->nombre?>', 'Lo más reciente')">
																<svg         class="gtm_class_redi_col_app_opened" viewBox="0 0 148.253 150">
																	<g><path class="gtm_class_redi_col_app_opened" fill-rule="evenodd" clip-rule="evenodd" d="M74.027,0.058c37.036-1.606,74.318,30.537,74.226,74.878c-0.088,43.053-35.125,75.344-74.689,75.063c-37.865-0.27-72.181-29.865-73.515-70.935C-1.431,33.571,30.971,0.058,74.027,0.058z"></path></g>
																	<g><path class="gtm_class_redi_col_app_opened" d="M76.697,0v4c16.848,0,33.871,7.376,46.707,20.239c13.484,13.513,20.89,31.514,20.85,50.688c-0.039,19.33-7.558,37.359-21.17,50.766C109.979,138.598,92.117,146,74.077,146l-0.484-0.002c-17.726-0.126-34.686-6.907-47.757-19.093C12.382,114.364,4.645,97.327,4.047,78.934C3.36,57.809,10.37,38.542,23.787,24.682c12.874-13.3,30.716-20.624,50.241-20.624c0.058,0,0.116-0.001,0.173-0.004C75.023,4.018,75.861,4,76.692,4L76.697,0 M76.691,0c-0.886,0-1.777,0.019-2.664,0.058c-43.057,0-75.458,33.514-73.979,79.006c1.334,41.069,35.65,70.665,73.515,70.935C73.735,150,73.906,150,74.077,150c39.354,0,74.089-32.198,74.177-75.065C148.343,31.655,112.832-0.003,76.691,0L76.691,0z"></path></g>
																	<path    class="gtm_class_redi_col_app_opened" d="M103.804,71.464L69.521,37.181c-1.43-1.43-3.581-1.857-5.449-1.084c-1.868,0.774-3.086,2.597-3.086,4.62v68.567c0,2.022,1.218,3.846,3.086,4.619c0.619,0.257,1.269,0.381,1.913,0.381c1.301,0,2.58-0.508,3.537-1.465l34.283-34.283C105.757,76.583,105.757,73.417,103.804,71.464z"></path>
																</svg>
															</div>
														</div>
													</div>
				...
				<div class="p_articleconte">
					...
					<div class="p_actividadesmenu">
						...
						<div class="p_actividadesmenubtn"
							...
							<div class="p_actmenubtntxt">{{ filtros.materias ? filtros.materias[0].n: 'Asignaturas'}}</div>
						</div>
						<!-- Temas -->
					...
					<div class="p_actividadescateg">
						...
						<div class="p_actividadescategopcion" ng-class="{'p_actividadescategopcion_select':catSimulador}">
