...
<div class = "p_flotanteicon"  onclick = "regresarLibros()">
	<div id = "linea1"></div>
	<div id = "linea2"></div>
	<div id = "linea3"></div>
</div>
	...
	<div class="p_emergenteusuario">        
		...
		<div class="p_emerbox">      
			...
			<!--form class="p_emerboxconte" id ="formLogin">
				...
				<div class="p_emerinfo" >¿Cómo obtener usuarioo y contraseña?</div>
				<div class="p_emerbtn">
					<!--table class="p_emerbtnin"><tr><td>ENTRAR</td></tr></table-->					
					<!--input id = "entrar" type ="submit" class="p_emerbtnin" value ="ENTRAR"/>
				</div>
			...
			<!--Pago Stripe-->            
			<form class="p_emerboxconte" id ="formCompra" action="https://www.krismar.com.mx/pagoKSR/bachillerato.php" method="POST" onsubmit="return validarForm();"> <!--Ventana 5-->
