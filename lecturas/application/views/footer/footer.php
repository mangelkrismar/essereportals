...
<footer class="p_footer" style="margin-top: 166px;">   
	<div class="p_footerin">    
		<div class="p_footerdatos"> 
			<a class="mustBeLogged Dir" href = "" target = "_blank">
			...
			<div class="p_footerdatosbox4">
				...
				<table>
					<tr>
						<td>soporte@krismar.com.mx</td>
					</tr>
				</table>
			</div>
			<div class="p_footerdatosboxredes">
				<div class="mustBeLogged Fb" href = ""></div>
				<div class="mustBeLogged Tr" href = ""></div>
				<div class="mustBeLogged Yt" href = ""></div>
			</div>            
		</div>            
