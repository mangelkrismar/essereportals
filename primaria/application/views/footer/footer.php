	...
	<div class="p_emergenteusuario">        
		...
		<div class="p_emerbox">            
			...
			<div class="p_emerboxconte" style="display: none" id = "informacion_usuario">
				...
				<div class="p_emerbtn" onclick = "muestraEmergente($('#edita_info'))">
		...
		<div class="p_emerbox">            
			...
			<form class="p_emerboxconte" id ="formLogin">
				...
				<div class="p_emerbtn p_bcenter1">
					...
					<input id = "compra" type ="submit" class="p_emerbtnin p_bcenter2" onclick="muestraComprar()" value ="COMPRAR"/>
				</div>
				<div class="p_emerinfo" onclick="muestraContraseniaOlvidada()">¿Olvidó su nombre de usuario o contraseña?</div>            
			</form>            
			<!--CONTRASEÑA OLVIDADA--> 
			<form class="p_emerboxconte" id ="formRepoPassword">           
				<div class="p_emertitle">Contraseña olvidada</div>
				<div class="p_emertexto">Sus detalles deben encontrarse primero en la base de datos del usuario. Por favor, escriba su nombre de usuario y en caso de que este sea correcto y tenga un correo registrado, se le enviarán datos para reestablecer su contraseña.</div>
				<div class="p_emertexto">Si no recuerda su usuario, este no tiene un correo registrado o tiene algun problema utilizando este servicio, por favor comuniquese a: <a href="mailto:soporte@krismar.com.mx">soporte@krismar.com.mx</a> o al teléfono: <a href="">722-271-6972</a>.</div>
				<div class="p_emerdatos">
					<div class="p_emerdatostxt">Nombre de usuario</div>
					<input class="p_emerdatosinput" type="text" placeholder="Nombre" required>
				</div>
				<!--<div class="p_emerdatos">
					<div class="p_emerdatostxt">Dirección de correo</div>
					<input class="p_emerdatosinput" type="email" placeholder="nombre@correo.com.mx">
				...
				<div class="p_emerbtn">
					<input type ="submit" id="sendRepoPass" class="p_emerbtnin" value ="ENVIAR"/>
				</div>				
			</form>			
			<!--BIENVENIDO-->
			<div class="p_emerboxbienvenido" style="display: none">
			...
			<!--Pago-->            
			<form class="p_emerboxconte" id ="formCompra" action="https://www.krismar.com.mx/pagoKSR/primaria.php" method="POST" onsubmit="return validarForm();">
			...
			<form class="p_emerboxconte" style="display: none" id ="formChangeUser">
				...
				<div class="p_emerdatos">
					<div class="p_emerdatostxt">Nombre de usuario</div>
					<input class="p_emerdatosinput" type="text" placeholder="Nombre" required  name = "newusername" id = "newusername" />
				</div>
				<div class="p_emerdatos">
					<div class="p_emerdatostxt">Contraseña</div>
					<input class="p_emerdatosinput" type="password" minlength="5" placeholder="********" required name = "passwordc1" id = "passwordc1" />
				</div>	
				<div class="p_emerdatos">
					<div class="p_emerdatostxt">Confirmar contraseña</div>
					<input class="p_emerdatosinput" type="password" placeholder="********" required name = "passwordc2" id = "passwordc2" />
				</div>	
				<div class="p_emerbtn">					
