...
<?php }else{ ?>
	...
	<div class="p_emergenteusuario">        
		...
		<div class="p_emerbox">            
			<!--USUARIO CON BOTON DE PAGO-->            
			<!-- class="p_emerboxconte" id ="formLogin">
				<!--Su sesión ha excedido el tiempo límite. Por favor, ingrese de nuevo.-->
				<!--div class="p_emeralerta"></div>
				<div class="p_emerdatos">
					<div class="p_emerdatostxt">Nombre de usuario</div>
				...
				<div class="p_emerinfo">¿OlvidóOO su nombre de usuario o contraseña?</div>            
			</form-->  
			...
			<!--Pago Stripe-->            
			<form class="p_emerboxconte" id ="formCompra" action="https://www.krismar.com.mx/pagoKSR/preescolar.php" method="POST" onsubmit="return validarForm();"> <!--Ventana 5-->
