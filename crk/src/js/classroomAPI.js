...
*
*************************************************************************************/
const CLIENT_ID = '1002854476119-ns091bdc63gr1qlro9uomm7l86fgn8bf.apps.googleusercontent.com';
const API_KEY = 'AIzaSyDkFWgdWdMGHlBG-h4ltORYOdgpEgNIQbg';
...
const dominio = 'krismarapps.mdt.mx'; //KrismarApps producción
const controller = 'classroomController'; //KrismarApps producción
/***********************************************************************************
* 
*                            *.*.*.*.*.*.* VARIABLES GLOBALES*.*.*.*.*.*.* 
*
