	...
	$.post(
		...
		function(data){
			...
			$.each(result, function(grado, libros){
				console.log(grado);
				if(grado == "E"){
					lista = '<li class="ExtraLibrosSep"><ol>';
				}else{
					lista = "<li><ol>";
				}
...
function imgTransition(){
    ...
    * VARIABLES****/
	...
	if(disp != "movil"){
		...
		$('.p_headerImg1').css('background-image', 'url('+IP+'src/img/p_headerimg1_.jpeg)');
		...
		$('.p_headerImg6').css('background-image', 'url('+IP+'src/img/p_headerimg6.png)');
		$('.p_headerImg7').css('background-image', 'url('+IP+'src/img/p_headerimg7.png)');
