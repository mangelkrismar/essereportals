	...
	$scope.clasePTema = function(nombre){
		...
		if(nombre){
			switch(nombre.toLowerCase()){
				...
				case 'desarrollo físico y salud'				: return 'p_temas_kfis';
				case 'exploración y conocimiento del mundo'		: return 'p_temas_kexp';
				case 'expresión artística'						: return 'p_temas_kart';
				case 'lenguaje y comunicación'					: return 'p_temas_kcom';
				case 'pensamiento matemático'					: return 'p_temas_kmat';
				case 'desarrollo personal y social'				: return 'p_temas_kper';
			}
			return '';
		}
		return '';
