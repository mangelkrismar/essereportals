...
<header class="p_header">
			...
			<div class="p_menuconte">	       
				<div class="p_menucontecenter">	      
					...
					<div class="p_menuicon contenido" name="temas" ng-click='ocultarApps()' onclick = "verSeccionGuest($(this))">	
						...
						<table class="p_menutxt"><tr><td>CAMPOS FORMATIVOS</td></tr></table>	          
					</div>							                   
					...
					<!--<div class="p_menuicon libros" id ="libros_sepi_nme" name = "libros_sep" onclick = "muestraLibrosNme()" >
						<div class="p_menuimg p_iconlibrosep">
							<div class = "p_iconlibrosepin"></div>
						</div>
					...
					<!-----GOOGLE CLASSROOM---->
					<div class="p_menuicon docente docente" name = "docente" onclick = "muestraDocente()" >
						<div class="p_menuimg p_iconguias">
							<?php $this->load->view('nav/guia_maestro.svg');?>
						</div>
						<table class="p_menutxt"><tr><td>REPORTES DE CLASSROOM</td></tr></table>
					</div>
					<!--<div class="p_menuicon docente" id ="aprendizajes_esperados" name = "aprendizajes_esperados" style="cursor: pointer;opacity: 0.5;display: block;">
						<div class="p_menuimg p_iconlibrosep">
							<div class = "p_iconlibrosepin"></div>
						</div>
						<table class="p_menutxt"><tr><td>APRENDIZAJES CLAVE</td></tr></table>
					</div>-->
					<!-------------------->
	...
	<div class="p_headerdatos" <?php if($this->bandera_movil){echo "style = 'height:50px'";}?>>  
		<div class="p_headertransition">  
            <div class = "p_headerImg7" ></div>  
            <div class = "p_headerImg6" ></div>
