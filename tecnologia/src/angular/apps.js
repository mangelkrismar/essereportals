...
app.controller("CursoController", function($scope, $http, $window){
	...
	$scope.clasePTema = function(nombre){
		...
		if(nombre){
			switch(nombre.toLowerCase()){
				...
				case 'nivel 1' 					: return 'p_temas_primero';
				case 'nivel 2' 					: return 'p_temas_segundo';
				case 'nivel 3' 					: return 'p_temas_tercero';
				case 'nivel 4' 					: return 'p_temas_cuarto';
				case 'nivel 5' 					: return 'p_temas_quinto';
				case 'nivel 6' 					: return 'p_temas_sexto';
				case 'excel' 					: return 'p_temas_excel';
				case 'power point' 				: return 'p_temas_ppoint';
				case 'word' 					: return 'p_temas_word';
	...
	$scope.filterNivel = function(nivel){
		return nivel.n.match(/Nivel.+/);
	}

	$scope.filterNoNivel = function(nivel){
		return !nivel.n.match(/Nivel.+/);
	}
