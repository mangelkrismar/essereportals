        ...
        if (strcmp ($res, "VERIFIED") == 0) { //PayPal nos verifica que la Info es correcta 
             ...
             **/ 
                 ...
                 */ 
				    ...
				    $conn = Conectarse();
				    //$query = "SELECT * FROM pandilla_user WHERE activo=0";     //EL quiery para saber si hay activos
				    $query = 'UPDATE pandilla_user SET activo=1, fCompra='.strtotime($date).' WHERE id = 1';
				    mysql_query($query,$conn);                         //Se ejecuta la consulta
					...
					$destinatario = "paypalc@krismar.com.mx";   /*Aqui va el correo del usuario q compro*/
