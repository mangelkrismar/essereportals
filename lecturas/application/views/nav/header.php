...
<header class="p_header">
		...
		<div class="p_menusup">	          
			<div class="p_menuconte">	       
				<div class="p_menucontecenter">	      
					...
					<div ng-show="materias.length > 1 && materias[0].n != 'Lecturas de comprensión'" class="p_menuicon contenido" name="temas" ng-click='ocultarApps()' onclick = "verSeccionGuest($(this))">	
					...
					<a onclick = "insertaLogLink('Krismar')" href = "" target="_blank">	
					...
					<div class="p_menuicon libros" id ="libros_sepi" name = "libros_sep" onclick = "" >
						<div class="p_menuimg p_iconlibrosep">
							<div class = "p_iconlibrosepin"></div>
						</div>
						<table class="p_menutxt"><tr><td>SEP</td></tr></table>
					</div>
					<div class="p_menuicon libros" id ="libros_sepi_nme" name = "libros_sep" onclick = "" >
						<div class="p_menuimg p_iconlibrosep">
							<div class = "p_iconlibrosepin"></div>
						</div>
						<table class="p_menutxt"><tr><td>SEP NME</td></tr></table>
					</div>
						...
						<a class="mustBeLogged Escolar" href = "" target="_blank">
							<?php } ?>						                                
						...
						<a class="mustBeLogged School" href = "" target="_blank">	
							<?php } ?>						                            
							<div class="p_menuicon p_iconresize britannica" name="britannica">   
								<div class="p_menuimg p_iconbritannica">
									<div class = "p_iconbritannicain"></div>
						...
						<a class="mustBeLogged Biografía" href = "" target="_blank">
							<?php } ?>						                               
							<div class="p_menuicon p_iconresize britannica" name="britannica">  
								<div class="p_menuimg p_iconbritannica">
									<div class = "p_iconbritannicain"></div>
						...
						<a class="mustBeLogged Mapas" href = "" target="_blank">				
							<?php } ?>	                    
							<div class="p_menuicon p_iconresize britannica" name="britannica">	                    
								<div class="p_menuimg p_iconbritannica">
									<div class = "p_iconbritannicain"></div>
	...
	<div class="p_headerdatos" <?php if($this->bandera_movil){echo "style = 'height:50px'";}?>>  
		<div class="p_headertransition"> 
			<div class = "p_headerImg5" ></div>
			<div class = "p_headerImg4" ></div>   
			<div class = "p_headerImg3" ></div>               
			<div class = "p_headerImg2" ></div>       
			<div class = "p_headerImg1" ></div>           
		</div>           
					...
					<?php if($this->session->userdata('log_in')){  ?>           
						...
						<?php if(!$this->config->item('mostrar_apps_a_visitantes')) {?>
							<div class="p_ingresarusuario">
								...
								<table class="p_ingresarname"><tr><td><?=$this->session->userdata('nombre');?></td></tr></table>    
							</div>
						<?php } ?>
					<?php }else{?>					
					<!--BOTON INGRESAR-->            
	...
	<nav class="p_navsup">  
		<div class="p_navsupin">      
			<!--<table class="p_navsupinbtn p_in1" id="contenido" onclick="verSubtemas(this.id)" ng-show="materias.length > 1 && materias[0].n != 'Lecturas de comprensión'"><tr><td>CONTENIDO</td></tr></table>        
			...
			<table class="p_navsupinbtn p_in4" id="libros" onclick="verSubtemas(this.id)"><tr><td>LIBROS</td></tr></table>
			<table class="p_navsupinbtn p_in5" id="contacto" onclick="verSubtemas(this.id)"><tr><td>CONTACTO</td></tr></table>-->

			<table class="p_navsupinbtn p_in1" ><tr><td></td></tr></table>
			<table class="p_navsupinbtn p_in2" id="primaria" ng-click="lookTo('primaria')"><tr><td>PRIMARIA</td></tr></table>
			<table class="p_navsupinbtn p_in4" ><tr><td></td></tr></table>
			<table class="p_navsupinbtn p_in3" id="secundaria" ng-click="lookTo('secundaria')"><tr><td>SECUNDARIA</td></tr></table>
			<table class="p_navsupinbtn p_in5" ><tr><td></td></tr></table>
		</div>  
	</nav>
</header>