        ...
        <article class="p_article bounceInLeft">
            <div class="p_articlecenter">
                ...
                <div class="p_articleconte">
                    <div class="p_articletitle">Básicas del pensamiento</div>
                    <div class="p_articleline"></div>
                                    ...
                                    <div class="p_recienteboxminiatura">
                                        ...
                                        <div class="p_recienteinfo">
                                            ...
                                            <div class="p_recienteinfoobjetivos" ng-if="!movil">
                                                <ul>
                                                    <li ng-repeat="objetivo in current_app_objectives_dem = filterObjetives(ap.objetivos)">• {{objetivo}}</li>
                                                </ul>
                                            </div>
                ...
                <div class="p_articleconte">
                    <div class="p_articletitle">Razonamiento verbal</div>
                    <div class="p_articleline"></div>
                    <div class="p_conocecenter">
                        <div style="min-height: 424px;">
                            <!-- Actividades -->
                ...
                <!-- Se muestran las actividades de bachillerato -->
                <div class="p_articleconte">
                    <div class="p_articletitle">Razonamiento matemático</div>
                    <div class="p_articleline"></div>
                    <div class="p_conocecenter">
                        <div style="min-height: 424px;">
                            <!-- Actividades -->
                            <div class="p_act4box bounceIn" ng-repeat="ap in appsFiltradasBachillerato track by $index">
                                <div class="p_recienteboximg" ng-class="movil?'p_resalteminiatura_over':'p_resalteminiatura'">
                                    <div class="p_recienteboxminiatura">
                                        <img ng-src="{{getAppThumbnail(ap.prefijo)}}">
                                        <div class="p_recienteboxicon"
                            ...
                            <!-- Cuando no se encuentran actividades -->
                            <div ng-if="appsFiltradasBachillerato.length === 0">
                                <table  style="display: table;width:100%;">
                                    <tr>
                                        <td class="p_conte_notificacionn">No se encontraron resultados.</td>
                                    </tr>
                        ...
                        <div class="p_conocecenter">
                            <div class="p_actnavcenter">
                                <div ng-if="paginaActual[2] == 1 || current_section != 2 || appsFiltradasBachillerato.length < 1" style="opacity: 0.3; cursor: default;" class="p_actnavarrowleft"></div>
                                <div ng-if="paginaActual[2] != 1 && current_section == 2 && appsFiltradasBachillerato.length > 0" style="opacity: 1.0; cursor: pointer;" class="p_actnavarrowleft" ng-click="changePage(paginaActual[2]-1)"></div>
                                <div style="float:left;">
                                    <div ng-if="current_section == 2" class="p_actnavnum"
                                    ng-repeat="pageNumber in pages = (paginasFiltradas[2] | orderBy)"
                                    ng-class="{ p_actnavnum_active : paginaActual[2] == pageNumber}"
                                    ng-click="changePage(pageNumber)">
                                    {{ pageNumber }}
                                    </div>
                                    <div ng-if="current_section != 2" class="p_actnavnum p_actnavnum_active_locked"
                                    ng-repeat="pageNumber in pages = (paginasFiltradas[2] | orderBy)"
                                    ng-class="{ p_actnavnum_active : paginaActual[2] == pageNumber}">
                                    {{ pageNumber }}
                                    </div>
                                </div>
                                <div ng-if="paginaActual[2] == paginas[2].length || current_section != 2 || appsFiltradasBachillerato.length < 1" style="opacity: 0.3; cursor: default;" class="p_actnavarrowright"></div>
                                <div ng-if="paginaActual[2] != paginas[2].length && current_section == 2 && appsFiltradasBachillerato.length > 0" style="opacity: 1.0; cursor: pointer;" class="p_actnavarrowright" ng-click="changePage(paginaActual[2]+1)">
                                </div>
                            </div>
                        </div>
                    </div>
